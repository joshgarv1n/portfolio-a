            ...
            <section id="hero" className="relative h-screen w-screen bg-hero-img bg-cover bg-center flex flex-col justify-center items-center">
                <div className="flex flex-col items-center">
                    ...
                    <div className="flex justify-center space-x-4 mt-6">
                        <a href="./public/resume.pdf" download className="flex items-center px-4 py-2 border-2 border-orange-500 text-neutral-50 rounded-full hover:bg-slate-400 hover:bg-opacity-50 hover:text-neutral-50 transition duration-300">
